    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          type: { type: "string", enum: ["LLC", "Corporation", "S-Corporation", "Partnership", "LP", "LLP", "Sole Proprietorship", "Non-Profit", "Trust", "PLLC", "PC", "Federal Corporation", "Federal Non-Profit", "Federal Cooperative", "Alberta Corporation", "Alberta ULC", "Alberta Partnership", "Alberta LP", "Alberta Sole Proprietorship", "BC Corporation", "BC ULC", "BC Partnership", "BC LP", "BC Sole Proprietorship", "Ontario Corporation", "Ontario Partnership", "Ontario LP", "Ontario LLP", "Ontario Sole Proprietorship", "Quebec Corporation", "Quebec Joint Stock Company", "Quebec Partnership", "Quebec LP", "Quebec LLP", "Quebec Sole Proprietorship", "Manitoba Corporation", "Saskatchewan Corporation", "Nova Scotia ULC", "New Brunswick Corporation", "PEI Corporation", "Newfoundland Corporation", "Yukon Corporation", "NWT Corporation", "Nunavut Corporation", "Ltd", "PLC", "LLP (UK)", "Partnership (UK)", "Sole Trader", "CIC", "Charity", "Scottish LP", "SARL", "SAS", "SASU", "SA", "SNC", "SCI", "EURL", "Auto-entrepreneur", "Association", "EOOD", "OOD", "AD", "EAD", "ET", "SD", "KD", "KDA", "Cooperative (Bulgaria)", "BV", "NV", "VOF", "CV", "Eenmanszaak", "Maatschap", "Stichting", "Vereniging", "Cooperatie", "Other"], description: "Entity type" },
          jurisdiction: { type: "string", description: "State or country of incorporation" },
          website: { type: "string", description: "Website URL" },
          status: { type: "string", enum: ["Active", "Inactive", "Delinquent", "Dissolved", "Pending"], description: "Entity status" },
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          type: { type: "string", enum: ["LLC", "Corporation", "S-Corporation", "Partnership", "LP", "LLP", "Sole Proprietorship", "Non-Profit", "Trust", "PLLC", "PC", "Federal Corporation", "Federal Non-Profit", "Federal Cooperative", "Alberta Corporation", "Alberta ULC", "Alberta Partnership", "Alberta LP", "Alberta Sole Proprietorship", "BC Corporation", "BC ULC", "BC Partnership", "BC LP", "BC Sole Proprietorship", "Ontario Corporation", "Ontario Partnership", "Ontario LP", "Ontario LLP", "Ontario Sole Proprietorship", "Quebec Corporation", "Quebec Joint Stock Company", "Quebec Partnership", "Quebec LP", "Quebec LLP", "Quebec Sole Proprietorship", "Manitoba Corporation", "Saskatchewan Corporation", "Nova Scotia ULC", "New Brunswick Corporation", "PEI Corporation", "Newfoundland Corporation", "Yukon Corporation", "NWT Corporation", "Nunavut Corporation", "Ltd", "PLC", "LLP (UK)", "Partnership (UK)", "Sole Trader", "CIC", "Charity", "Scottish LP", "SARL", "SAS", "SASU", "SA", "SNC", "SCI", "EURL", "Auto-entrepreneur", "Association", "EOOD", "OOD", "AD", "EAD", "ET", "SD", "KD", "KDA", "Cooperative (Bulgaria)", "BV", "NV", "VOF", "CV", "Eenmanszaak", "Maatschap", "Stichting", "Vereniging", "Cooperatie", "Other"] },
          jurisdiction: { type: "string" },
          website: { type: "string" },
          status: { type: "string", enum: ["Active", "Inactive", "Delinquent", "Dissolved", "Pending"] },
